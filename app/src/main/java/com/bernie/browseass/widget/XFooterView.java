...
//    private ImageView mHintImage;
    ...
    private void initView(Context context) {
        ...
        no_more_video = (TextView) mLayout.findViewById(R.id.no_more_video);
...
//                    mHintImage.startAnimation(mRotateUpAnim);
    ...
    public void hide() {
        ...
        no_more_video.setVisibility(View.VISIBLE);
    }
    ...
    public void show() {
        ...
        ll_content.setLayoutParams(lp);
        no_more_video.setVisibility(View.GONE);
    }

package com.bernie.browseass.widget;
...
//    private static final String TAG = "XListView";
    ...
    private TextView mHeaderTime, mFooterLoadMore;
    private int mHeaderHeight;

    private LinearLayout mFooterLayout, ll_content;
    ...
    private void initWithContext(Context context) {
        ...
        ll_content = (LinearLayout) mHeader.findViewById(R.id.ll_content);
        addHeaderView(mHeader,null,true);

        // init footer view
        mFooterView = new XFooterView(context);
        ll_content = (LinearLayout) mFooterView.findViewById(R.id.ll_content);
        mFooterLoadMore = (TextView) mFooterView.findViewById(R.id.footer_hint_text);
    ...
    public void setColorFooter(int color, int colorText) {
        ll_content.setBackgroundColor(color);
        mFooterLoadMore.setTextColor(colorText);
    }
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (!mIsFooterReady) {
            mIsFooterReady = true;
            addFooterView(mFooterLayout,null,true);
        }
